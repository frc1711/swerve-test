...
public class SwerveDrive {
	 ...
	 */
	public SwerveDrive(double kP, double kI, double kD, Encoder iEncFL, Encoder iEncRL, Encoder iEncFR, Encoder iEncRR, SpeedController spFL, SpeedController spRL, SpeedController spFR, SpeedController spRR, SpeedController iTransFL, SpeedController iTransRL, SpeedController iTransFR, SpeedController iTransRR, boolean invertWheelRotation, width, length) {
		transFL = iTransFL;
		transRL = iTransRL;
		transFR = iTransFR;
		transRR = iTransRR;
		...
		setWheelbaseDimensions(width, length);
